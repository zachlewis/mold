$(function() {
  ...
  var annotations = [
        ...
        new Annotation(s, {top: 140,  left: 256,  height: 86, width: 113, name: 'commits'}),
        new Annotation(s, {top: 137, left: 376, height: 89, name: 'build'}),
        new Annotation(s, {top: 137, left: 473, height: 89, name: 'pr'}),
        new Annotation(s, {top: 140,  left: 610,  height: 86, width: 145, name: 'code-review'}),
        new Annotation(s, {top: 137, left: 758, height: 89, name: 'deploy'}),
        new Annotation(s, {top: 20,  left: 943, height: 207, name: 'merge'})
  ];
